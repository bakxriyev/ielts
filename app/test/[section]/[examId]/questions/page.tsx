...
export default function TestPage() {
  ...
  const fetchTestData = async () => {
    try {
      ...
      const videoUrls = {
        reading: "/videos/reading-instructions.mp4",
        listening: "/videos/listening-instructions.mp4",
        writing: "/videos/writing-instructions.mp4",
      }

      setTestData({
        id: examId,
        title: `${data.title} - ${sectionTitle} Test`,
        videoUrl: videoUrls[section as keyof typeof videoUrls] || "/videos/default-instructions.mp4",
        section: section,
      })
    } catch (error) {
